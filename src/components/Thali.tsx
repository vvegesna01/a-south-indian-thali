...
const Thali = () => {
  ...
  // Motion styles for images
  const useGetMotionStyles = (
    start: number,
    end: number
  ) => {
    return {
  ...
  return (
    <motion.div className="fixed inset-0 bg-gradient-to-b from-green-50 to-green-100">
      <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100 p-1 sm:p-4">
        <div ref={containerRef} className="relative h-[100vh]">
          <div className="absolute inset-0 flex flex-wrap justify-center gap-8 sm:gap-4">
            ...
            <motion.div
              ...
              style={useGetMotionStyles(0.50, 0.70)}
              whileHover={{
                rotate: 15,
            ...
            <motion.div
              ...
              style={useGetMotionStyles(0.55, 0.75)}
        ...
        >
          <Image
            ...
            style={{
              marginBottom: "0px",
              transform: "translateX(60vh) translateY(45vh)",
            }}
          />
        </motion.div>
      </div>
